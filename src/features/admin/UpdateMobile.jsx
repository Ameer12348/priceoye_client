    ...
    const getProdust = async () => {
      try {
        ...
        if (response.ok) {
          ...
          processor.current.value = data.productDetails.processor;
          gpu.current.value = data.productDetails.gpu;
          frontCamera.current.value = data.productDetails.frontCamera;
          backCamera.current.value = data.productDetails.backCamera;
          connectivity.current.value = data.productDetails.connectivity;
          radio.current.value = data.productDetails.radio;
          wifi.current.value = data.productDetails.wifi;
